...
def generate_script(subject, video_length, creativity, api_key):
    ...
    # subject_chain = subject_template | model
    # script_chain = script_template | model
    subject_chain = subject_template
    script_chain = script_template
    # title = subject_chain.invoke({"subject": subject}).content
    title = subject_chain.invoke({"subject": subject})
